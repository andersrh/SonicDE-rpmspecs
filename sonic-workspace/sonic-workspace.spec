...
%define oldname plasma-workspace
...
Provides:       plasmashell(desktop) = %{version}
...
Obsoletes:  %{oldname}-wayland < 6.4.1-2
Conflicts:  %{oldname}-wayland < 6.4.1-2
